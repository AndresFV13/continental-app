    ...
    return (
        <Header>
            <nav className="d-flex align-items-center w-80">
                <Link className="d-block mr-3" to="/">Alumnos</Link>
                <Link className="d-block mr-3" to="/instructores">Instructores</Link>
                <Link className="d-block mr-3" to="/vehiculos">Vehiculos</Link>
            </nav>
